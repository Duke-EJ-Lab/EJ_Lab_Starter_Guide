...
4)  Date records were assigned using the earliest action on a case.\\ 5)
    Standardized spelling and abbreviations.\\ 6) Cleaned city names,
    state abbreviations, and zipcodes via comparison to standardized
    listings of city names and state abbreviations (fom Zip Codes To Go
    and Zip Code Tabulation Areas). Used MatchIt program in Stata to
    find best standardized match.

5)  Geocoding was done by submitting the files to the Environmental
...
6)  Estimation of prevalence: case outcome was classified as eviction if
...
7)  To calculate eviction and filing rates, the number of evictions and
...
5)  The 'cities', 'counties', 'states' files in the downloaded data
    ...
    Datasets' as well as 'Cleaned CSV Datasets" \### InfoUSA {-}
