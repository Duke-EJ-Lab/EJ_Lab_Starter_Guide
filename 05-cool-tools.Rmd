...
* **[Our lab package](https://github.com/Duke-EJ-Lab/lab.tools)**: an R package with a mismash of random helpful or fun functions. A sample of functions below. Anyone can add to the package, and it's great to learn how to build a package!! Any useful functions you stumble upon can be added here (but make sure to include credit to the creator).
