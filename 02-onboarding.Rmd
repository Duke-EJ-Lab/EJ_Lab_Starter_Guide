...
* **Connect to EJ Lab virtual machine**: Open the Remote Desktop Application, click "+ Add" to add a new PC. The PC name is **res-ejlab-pap1.oit.duke.edu**.  Your netid and password are required to login.

* **OPTIONAL - Git account**: For users who will be coding, ensure you have a Git account and request access from EJLab staff.
...
* Research Toolkits:  Add the user's netid in Research Toolkits.  Once the user's netid is added, the netid now has permissions to log into the EJ Lab remote computer.
* Create user folder in student or affiliate network attached storage drive
* If appropriate, invite user to Git account, invite to specific folders as needed
...
(1) For non-student partners: \\oit-nas-fe13dc.oit.duke.edu\data_commons-ejlab_partners
(2) For student and postdoctoral research: \\oit-nas-fe13dc.oit.duke.edu\data_commons-ejlab_students
(3) for project data: \\oit-nas-fe13dc.oit.duke.edu\data_commons-ejlab_general
(4) for project archive: \\oit-nas-fe13dc.oit.duke.edu\data_commons-ejlab_archive
